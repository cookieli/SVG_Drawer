...
//            std::fill(supersample_render_target.begin(), supersample_render_target.end(), 0);
    ...
    private:
        ...
        void rasterize_point(point p, Color color);
        ...
        void fill_in_rectangle(Rectangle &r, Color color);

        void rasterize_points_in_box(Rectangle r, std::vector<point> &anticlockTriangle, Color color);
        // rasterize an image
